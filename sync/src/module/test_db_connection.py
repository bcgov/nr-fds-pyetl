...
# Move all calls to this module to the database_connnection.py module
...
class test_db_connection:
    ...
    def do_test(database_config):
        ...
        if database_config["type"] == "POSTGRES":
            ...
            connection_string = test_db_connection.format_connection_string(
                database_config
            )
